"""
Simple script to convert NIST SP-800-66 excel in a Auditrex Excel file
...
parser = argparse.ArgumentParser(
    ...
    description="convert NIST SP-800-66 controls offical Excel file to Auditrex Excel file",
)
