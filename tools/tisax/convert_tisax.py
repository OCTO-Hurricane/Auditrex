"""
Simple script to convert TISAX v6.0.2 excel in a Auditrex Excel file
...
parser = argparse.ArgumentParser(
    prog="convert_tisax",
    description="convert TISAX controls offical v6.0.2 Excel file to Auditrex Excel file",
)
