"""
Simple script to convert ENISA's 5G Security Controls Matrix v1.3 Excel in a Auditrex Excel file
...
parser = argparse.ArgumentParser(
    prog="convert_5g_scm",
    description="convert 5G Security Controls Matrix v1.3 Excel file to Auditrex Excel file",
)
