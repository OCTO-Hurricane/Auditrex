"""
Simple script to convert AirCyber v1.5.2 excel in a Auditrex Excel file
...
parser = argparse.ArgumentParser(
    ...
    description="convert AirCyber controls offical v1.5.2 Excel file to Auditrex Excel file",
)
...
Permission given to include AirCyber in Auditrex.
"""
packager = "intuitem"
