"""
simple script to transform the official CCM Excel file to another Excel file for Auditrex framework conversion tool
"""
...
parser = argparse.ArgumentParser(
    prog="convert_ccm",
    description="convert CCM controls offical Excel file to Auditrex Excel file",
)
