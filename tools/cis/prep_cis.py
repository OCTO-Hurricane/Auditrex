"""
simple script to transform the official CIS Excel file to another Excel file for Auditrex framework conversion tool
"""
...
parser = argparse.ArgumentParser(
    prog="convert_cis",
    description="convert CIS controls offical Excel file to Auditrex Excel file",
)
