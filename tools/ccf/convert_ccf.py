"""
Simple script to convert Adobe CCF Security Controls v5 Excel in a Auditrex Excel file
...
parser = argparse.ArgumentParser(
    prog="convert_ccf",
    description="convert Adobe CCF Security Controls v5 Excel file to Auditrex Excel file",
)
